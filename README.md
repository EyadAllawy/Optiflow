...
- Amr Abdulazim → Responsible for (Build data model, data cleaning & preprocessing)
- Abdulrahman Mekky → Responsible for (Analysis Questions Phase)
- Mahmoud Rashidy → Responsible for (Forecasting Questions Phase)
- Eyad Allawy → Responsible for (Visualization Dashboard and Final Presentation)
________________________________________
Instructor
Eng. Kareem Bakly
________________________________________
...
of OPTIFLOW Project (2025)

Full license text: CC BY 4.0
